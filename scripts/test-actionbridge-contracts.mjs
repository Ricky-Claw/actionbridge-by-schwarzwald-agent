...
if (!process.exitCode) {
  ...
  for (const token of ['enforceActionBridgeRateLimit', 'ACTIONBRIDGE_RATE_LIMITED', 'Retry-After', 'setupSession', 'bridgeHandshake', 'domainVerification', 'keyDigest', 'ACTIONBRIDGE_RATE_LIMIT_MODE', 'pilot_process_local', 'ACTIONBRIDGE_PRODUCTION_RATE_LIMIT_REQUIREMENTS', 'createActionBridgeRateLimitHeaders', 'MAX_PILOT_BUCKETS']) {
