    ...
    <main className="min-h-screen bg-[#07130f] text-stone-100">
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="rounded-[2rem] border border-emerald-300/20 bg-gradient-to-br from-emerald-950 via-[#0b1712] to-black p-8 shadow-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.35em] text-emerald-300">Schwarzwald-Agent × ActionBridge</p>
          <h1 className="mt-5 max-w-4xl text-5xl font-black tracking-tight">Every approved website becomes a safe agent tool.</h1>
          <p className="mt-5 max-w-3xl text-lg text-stone-300">ActionBridge is the permissioned connector layer: customers verify their site, install a lightweight bridge when needed, choose allowed actions, and Schwarzwald-Agent receives safe tools instead of raw access.</p>
